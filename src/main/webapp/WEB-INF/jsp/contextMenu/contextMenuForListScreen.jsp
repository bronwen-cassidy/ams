...
<tilesx:useAttribute id="contextMenu_removeFromList" name="contextMenu.removeFromList"/> 
...
<div class="contextmenu">
    <ul>
        ...
        <li><a href="#"><i class="fa clip-copy-2"></i> Clone</a></li>
        ...
        <li><a class="selected-rows-dependant" data-selected-row-attrs="bucketId=entityIds" href="${pageContext.request.contextPath}/das/list/removeFromList?id=${entityList.id}&versionNumber=${entityList.versionNumber}&name=${entityList.name}&"><i class="fa fa-minus"></i>Remove from list</a></li>
        <hr>
