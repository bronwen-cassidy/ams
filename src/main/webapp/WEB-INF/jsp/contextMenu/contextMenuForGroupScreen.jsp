...
<tilesx:useAttribute id="contextMenu_removeFromGroup" name="contextMenu.removeFromGroup"/> 
...
<div class="contextmenu">
    <ul>
		...
		<li><a class="selected-rows-dependant" data-selected-row-attrs="assetId=assetIds" href="${pageContext.request.contextPath}/das/group/removeFromGroup?id=${group.id}&versionNumber=${group.versionNumber}&name=${group.name}&"><i class="fa fa-minus"></i>Remove from group</a></li>
    </ul>
</div>