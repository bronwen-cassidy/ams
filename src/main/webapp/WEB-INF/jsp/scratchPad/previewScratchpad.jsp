...
<tilesx:useAttribute id="scratchpad_preview_search" name="preview_search"/>
...
<div class="panel panel-default" data-scratchpad-url="${scratchpad_url}" data-preview-search="${scratchpad_preview_search}">
	<div class="panel-heading scratchpad-header-preview collapsed" data-toggle="collapse" data-parent="#${parentAccordian}" href="#${scratchpad_id}_accordian">
	...
	<div id="${scratchpad_id}_accordian" class="scratchpad-body panel-collapse collapse">
		<ul class="panel-body preview-panel-body">
